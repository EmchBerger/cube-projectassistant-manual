...
The arrows \includegraphics[height=12pt]{/Icons/Pfeil_rechts.jpg} allow you to expand the structure and the plus symbols \includegraphics[height=12pt]{/Icons/Pluszeichen.jpg} enable you to add tags. This way you can add as many tags as you like. In the photo on the right, the search result for the tag 'Logistic' is shown \col{(2)}. The structure is displayed in such a way as to show all the branches in which this tag is classified. This tag is not automatically selected, but needs to be manually added by clicking on the plus symbol \includegraphics[height=12pt]{/Icons/Pluszeichen.jpg}. The triangle symbol \includegraphics[height=12pt]{/Icons/welcheSpalte_sort.jpg} serves to display the rest of the tags that are classified in a branch of the structure but that are not part of the search result. \newline
