...
The 'copy' symbol \includegraphics[height=12pt]{/Icons/kopieren.jpg} allows you to create a copy of an existing meeting participant list. Click on the symbol to open the copy, which you can then adapt according to your needs. The copy can be distinguished by the three stars at the beginning and end of its name, for example: ***Meeting participants***.
