...
In the menu on the left, click on the menu item 'Import' then on the sub-item 'Address list data' \col{(1)}. On the right, under 'Template' \col{(2)}, you can see which fields are supported and how the table should be prepared in order to guarantee a successful import.

\vspace{\baselineskip}

Click on 'Browse' \col{(3)} and select the desire file. After selecting the Excel document and clicking on 'OK', you can see which file will be imported:
...
If everything is correct, click on the 'Import' button \col{(4)}. The addresses will be imported and available in the 'Address List' menu. 
