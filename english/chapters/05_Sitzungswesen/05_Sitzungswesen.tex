...
\item import the meeting invitation as a .ics-Datei to your Outlook calendar \includegraphics[height=12pt]{/Icons/Kalenderimport.jpg} \col{(8)},
...
The status column \col{(13)} shows if meeting minutes have been archived and are thus 'Final'. If a meeting has this status, the above described options are no longer available. Using the sheet symbol \includegraphics[height=12pt]{/Icons/Blattsymbol.jpg}, finalized meeting minutes can be opened or saved as a PDF file.
