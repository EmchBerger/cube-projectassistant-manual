...
Give your username and your password. When you click on 'Log in', your personal overview appears.
...
Additionally, all list column titles highlighted in blue work as buttons \col{(1)}. By clicking on a column title, the list is sorted in ascending order according to this column. By clicking again on the column title, the order is inverted. The small triangle \includegraphics[height=10pt]{/Icons/welcheSpalte_sort.jpg} \col{(2)} shows according to which column the list is sorted (in this example according to 'Archive Status') and in which order it is sorted: (Sorting A {\textgreater} Z \includegraphics[height=10pt]{/Icons/Status_down.jpg} or Z {\textgreater} A \includegraphics[height=10pt]{/Icons/Status_up.jpg}).
