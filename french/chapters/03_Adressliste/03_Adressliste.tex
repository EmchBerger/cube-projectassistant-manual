...
Vous avez la possibilité de télécharger une vCard (carte de visite par exemple pour Outlook). Cliquez sur le symbole vCard \includegraphics[height=12pt]{/Icons/vCard.jpg} \col{6)}. Vous aurez le choix de soit ouvrir 
...
Si vous cliquez sur le symbole de modification \includegraphics[height=12pt]{/Icons/Bearbeiten.jpg} \col{(9)}, vous pouvez changer les données d'une personne ou d'une entreprise. Pour ce faire vous devez disposer des droits d'accès nécessaires. Cliquez sur le symbole de crayon \includegraphics[height=12pt]{/Icons/Stift.jpg} \col{(10)} pour aller directement aux paramètres de l'utilisateur (dans le menu de gestion des utilisateurs). Vous avez également besoin des droits d'accès nécessaires pour faire des modifications.
