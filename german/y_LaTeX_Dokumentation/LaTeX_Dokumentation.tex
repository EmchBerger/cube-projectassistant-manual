...
\usepackage[left=1.5cm,right=1.5cm,top=2cm,bottom=2cm]{geometry} % Required to change the page size to A4
...
\HRule \\[0.4cm]
{ \huge \bfseries LaTeX Dokumentation}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]

\textsf{\Large für CUBE Benutzerhandbuch}\\[0.5cm] % Major heading such as course name
\textsf{\large Version 0.4 (Entwurf) / 29.04.2019}\\[0.5cm] % Minor heading such as course title
