...
\begin{wrapfigure}[3]{r}{6.5cm}   % [x] Wie manche Zeile soll sich um die Grafik "brechen"
  \vspace{-55pt}      % Grundwert war 20; mit 30 schön oben beim Text ausgerichtet
  \begin{center}
...
\begin{wrapfigure}[6]{l}{7cm}   % [x] Wie manche Zeile soll sich um die Grafik "brechen"
  \vspace{-70pt}      % Grundwert war 20; mit 30 schön oben beim Text ausgerichtet
  \begin{center}
...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/14_Benutzerverwaltung/pictures/Untergruppen_berechtigen.jpg}}
...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/14_Benutzerverwaltung/pictures/Gremien.jpg}}
