...
In der Übersicht der Benutzer kann wie gewohnt nach Begriffen gefiltert oder gesucht werden. Aufgelistete Benutzer können in der Benutzerverwaltung angezeigt oder bearbeitet werden \col{(3)}. \textbf{Es ist jedoch nicht möglich, hier neue Benutzer anzulegen. Neue Einträge (Personen und Firmen) müssen in der Adressliste erfasst werden (siehe Kapitel \ref{bkm:Ref443738751}.} \\
