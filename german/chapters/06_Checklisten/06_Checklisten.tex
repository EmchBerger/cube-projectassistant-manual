...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/06_Checklisten/pictures/Elemente_kopieren.jpg}}
\caption{Neue Items / Prüfpunkte kopieren}
% \label{fig:speciation}
\end{figure}

Zu zuunterst sehen Sie den Button \includegraphics[height=14pt]{/Icons/Elemente_kopieren.jpg}. Sie können die angezeigten Items/Prüfpunkte in eine andere, bestehende Checkliste kopieren.\\
...
\begin{figure}[H]
\center{\includegraphics[width=.4\linewidth]{../chapters/06_Checklisten/pictures/ckl_Uebernehmen.jpg}}
% \caption{Checklisten bei den Vorbehalten verknüpfen}
% \label{fig:speciation}
\end{figure}
