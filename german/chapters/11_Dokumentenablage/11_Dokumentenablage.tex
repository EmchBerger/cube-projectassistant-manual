...
\textbf{Hinweis:} Verwenden Sie mehrere Tag-Kacheln, können Sie aus allen Kacheln beliebige Tags anwählen; diese werden dem Filterfeld hinzugefügt. In den erweiterten Filtereinstellungen \col{(4)} wird die UND-Verknüpfung \col{(5)} hinterlegt und es werden die erforderlichen Tags 'ausgeschlossen'.
