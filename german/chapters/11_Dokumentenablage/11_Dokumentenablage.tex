...
\begin{wrapfigure}[6]{r}{4.5cm}   % [x] Wie manche Zeile soll sich um die Grafik "brechen"
...
Mit 'Übernehmen' werden die Änderungen gespeichert und mit dem Listensymbol \includegraphics[height=12pt]{/Icons/Listensymbol_zurueck.jpg} kehren Sie zur Übersicht zurück. Oder klicken Sie auf \includegraphics[height=14pt]{/Icons/ueb_schliessen.png}, um nach dem Speichern direkt zur Übersicht zu gelangen.
...
\textbf{Hinweis:} Wurde ein Dokument einem strukturierten Dossier hinzugefügt, können Sie in der Dokumentenablage mit Klick auf den Pfeil \includegraphics[height=12pt]{/Icons/Pfeil_l.jpg} direkt in das strukturierte Dossier wechseln.
...
\begin{figure}[H]
\center{\includegraphics[width=.75\linewidth]{../chapters/11_Dokumentenablage/pictures/pgv_Dossier.jpg}}
  \vspace{-5pt}
\caption{Strukturiertes Dossier - Plangenehmigungsverfahren}
% \label{fig:speciation}
\end{figure}

Wurde die Grundstruktur mit den Überschriften \col{(1)} aufgebaut, lassen sich beliebig viele Strukturelemente (Tags) \col{(2)} in verschiedenen Ebenen erstellen. Bei den einzelnen Elementen (Tags) können Sie nun die Dokumente verknüpfen. In der letzten Spalte sehen Sie den Status des hochgeladenen Dokumentes.
...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/11_Dokumentenablage/pictures/pgv_DokEdit.jpg}}
% \vspace{-5pt}
...
%  \caption{Tagstruktur}
  \vspace{-10pt}
\end{wrapfigure}
Im Bearbeitungsmodus eines Dokuments wird das strukturierte Dossier verknüpft \col{(3)}. Klicken Sie auf den Button Tagstruktur \col{(4)}, um das Dokument innerhalb der Gliederung in der gewünschten Position einzureihen:

\vspace{1.5cm}

Nach der Auswahl der Tags mittels \includegraphics[height=12pt]{/Icons/Pluszeichen.jpg}-Symbol (wo in der Struktur das Dokument verknüpft werden soll) und dem Speichern der Einstellungen, steht das Dokument im PGV-Dossier zur Verfügung. Über die Struktur können Sie direkt in den Ansichtsmodus des Dokuments wechseln (Klick auf das  \includegraphics[height=12pt]{/Icons/Blattsymbol.jpg}-Symbol).
...
Bei Dossiers können wie bei den Dokumenten Workflows angewendet werden. Klicken Sie auf die Pfeile \includegraphics[height=12pt]{/Icons/Status_aendern.jpg} \col{(1)} um den Workflow- / Status-Dialog zu öffnen:

\vspace{1cm}

\begin{figure}[H]
\center{\includegraphics[width=.8\linewidth]{../chapters/11_Dokumentenablage/pictures/doss_WorkflowDialog.jpg}}
  \vspace{-5pt}
...
\textbf{Hinweis:} Wenn Sie in der Dokumentenübersicht bei den Filterfeldern 'Dossier' und/oder 'Tags' Auswahlen getroffen haben und mittels dem Plussymbol \includegraphics[height=12pt]{/Icons/Plussymbol.jpg} \col{(1)} ein neues Dokument hochladen wollen, werden diese Auswahlen in der Maske für den neuen Dokumenteneintrag bereits hinterlegt:

\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/11_Dokumentenablage/pictures/11-2-2_FilterNeuesDok.jpg}}
\caption{Filter-Voreinstellungen übernehmen}
% \label{fig:speciation}
\end{figure}

\textbf{Ein neues Dokument hochladen:}
...
\textbf{Eine Datei \col{(2)} hochladen:}
...
\begin{figure}[H]
\center{\includegraphics[width=.4\linewidth]{../chapters/11_Dokumentenablage/pictures/11-2-2_Link_Fehler.jpg}}
...
\textbf{Hinweis:} Klicken Sie auf das \includegraphics[height=12pt]{/Icons/Fragezeichen.jpg}-Symbol \col{(a)}, erhalten Sie eine Übersicht über die Standard-Rechte.\\
...
\begin{figure}[H]
\center{\includegraphics[width=0.65\linewidth]{../chapters/11_Dokumentenablage/pictures/11-2-2_FehlerDokumentErsetzen.jpg}}
...
\begin{figure}[H]
\center{\includegraphics[width=0.4\linewidth]{../chapters/11_Dokumentenablage/pictures/11-2-2_Meldung_gleicheDatei.jpg}}
...
\textbf{Hinweis:} Wurden für die Dokumentenablage mehrere Workflows definiert (Siehe auch Statussysteme / Workflows Kapitel \ref{bkm:Ref2018073101}), erscheint in der Erfassungsmaske ein zusätzliches Feld, in welchem Sie den Startstatus festlegen müssen (Pflichtfeld) \col{(1)}:  

\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/11_Dokumentenablage/pictures/dok_HochladenStatus.jpg}}
...
\begin{figure}[H]
\center{\includegraphics[width=0.45\linewidth]{../chapters/11_Dokumentenablage/pictures/11-2-3_DialogLoeschen.jpg}}
...
Unter 'Statischer Link zu aktuellster Datei-Version' \col{(7)} wird auf den aktuellste Dokumenteneintrag des Dokuments referenziert. Sie können diesen Link z.B. per Mail versenden und dadurch gewährleisten, dass der Empfänger in jedem Fall auf den aktuellste Dokumenteneintrag des Dokuments und somit auf die letzte Dokumentenversion verwiesen wird. Um ein Dokument zu bearbeiten, wird es ausgecheckt \col{(8)}. Mehr zu diesem Thema finden Sie in Kapitel \ref{bkm:Ref442780171} (Dokumente online bearbeiten / Aus- und Einchecken der Dokumente).

\vspace{\baselineskip}

Unter 'Vorschau' \col{(9)} werden die ersten Seiten des Dokuments in einer verkleinerten Darstellung angezeigt.

\vspace{\baselineskip}

Durch Klicken auf eine Seite der Vorschau \col{(10)}, wird das Dokument im Vorschaumodus auf der entsprechenden Seite geöffnet. Der Vorschaumodus wird durch Klicken auf das graue Kreuzchen \includegraphics[height=12pt]{/Icons/X_Button.jpg} \col{(a)} in der rechten oberen Ecke wieder geschlossen. Mit \includegraphics[height=11pt]{/Icons/Weiter.jpg} , respektive \includegraphics[height=11pt]{/Icons/Zurueck.jpg} \col{(b)} können Sie durch die Seiten des Dokuments blättern. Unterhalb der Seitennavigation ist ersichtlich wie viele Seiten das Dokument umfasst \col{(c)}. Mit dem 90°-Symbol \includegraphics[height=12pt]{/Icons/90Grad.jpg} \col{(d)} können Sie die Seiten jeweils um 90° drehen.
...
Detailliertere Informationen zu strukturierten Dossiers finden Sie in Kapitel \ref{bkm:Ref2018073102}.
...
\textbf{Veränderungen}: Unter dem Punkt 'Veränderungen' können Sie sich durch Klicken auf das Symbol \includegraphics[height=12pt]{/Icons/Pfeil_rechts_g.jpg} \col{(3)} die Änderungen des Dokuments anzeigen lassen.
...
Nachdem Sie die gewünschten Dokumente in der Dokumentenübersicht ausgewählt haben (mittels Checkboxen \includegraphics[height=12pt]{/Icons/checkbox_markiert.jpg}), klicken Sie auf das Versandsymbol \includegraphics[height=12pt]{/Icons/dk_senden.jpg}. Sämtliche Dokumente im Dokumentenkorb werden an eine oder mehrere Emailadressen zu versenden. Sie können vor dem Absenden immer noch Dokumente löschen, welche Sie nicht versenden wollen.\\ 

\textbf{Hinweis:} Alternativ zum Versand durch CUBE ProjectAssistant können Sie eine Outlookvorlage öffnen und das Mail vor dem Senden bearbeiten. Stellen Sie den Schalter entsprechend auf 'Outlook' \col{(A)}.
...
Empfänger eintragen \col{(1)}: Geben Sie bei 'Empfänger' eine oder mehrere Emailadressen ein. Trennen Sie die Emailadresse mittels ';' oder einem Leerschlag. \textbf{Hinweis:} Versenden Sie Dokumenten durch CUBE ProjectAssistant ist es Pflicht, mindestens einen Empfänger einzutragen (Pflichtfeld). Wurde 'Outlook' als Versandart gewählt, können später weitere E-Mailadressen an 'An', 'Cc' oder 'Bcc' hinzugefügt werden.\\
Unter 'Nachricht' \col{(2)} können Sie für den oder die Empfänger die nötigen Informationen eingeben. Werden die Dokumente durch Outlook versendet, können Sie die Nachricht noch bearbeiten.\\ 
Die ausgewählten Dokumente werden aufgelistet und mit Klick auf den blauen Titel lassen sich die Dokumente herunterladen \col{(3)}. Im Dropdownmenü hinter den Dokumenten können Sie auswählen, ob ein Dokument als E-Mail-Attachement \col{(4)} oder als Link im Email \col{(5)} versendet werden soll. Mit dem Kreuzchen \includegraphics[height=12pt]{/Icons/blKreuzchen.jpg} \col{(6)} lassen sich Dokumente auch wieder löschen. Die Grösse sämtlicher Dokumente, welche als 'E-Mailbeilagen' versendet werden, ist unter \col{(7)} ersichtlich. Beachten Sie, dass grosse Dateien in der Regel nicht per Email-Attachement versendet werden können. In solchen Fällen verwenden Sie den Versand per Link \col{(5)}. Haben Sie alle nötigen Angaben gemacht, klicken Sie auf 'Senden' \col{(8)}, um den Sendeauftrag abzuschliessen oder die Nachricht im Outlook zu öffnen. Wurde unter \col{(A)} 'Outlook' ausgewählt, wird nun eine Outlook-Nachricht generiert und geöffnet.\\
...
\begin{figure}[H]
\center{\includegraphics[width=.35\linewidth]{../chapters/11_Dokumentenablage/pictures/11-dkorb_Sendebestaetigung}}
...
\begin{wrapfigure}[13]{l}{10cm}   % [x] Wie manche Zeile soll sich um die Grafik "brechen"
  \vspace{-30pt}      % Grundwert war 20; mit 30 schön oben beim Text ausgerichtet
  \begin{center}
...
\textbf{Hinweis:} Ein Download-Link hat eine Gültigkeitsdauer von \textbf{einem Monat}.
...
\begin{figure}[H]
\center{\includegraphics[width=.45\linewidth]{../chapters/11_Dokumentenablage/pictures/11-dkorb_Meldung_doppeltePerson.jpg}}
...
\begin{wrapfigure}[5]{r}{8cm}   % [x] Wie manche Zeile soll sich um die Grafik "brechen"
  \vspace{-30pt}      % Grundwert war 20; mit 30 schön oben beim Text ausgerichtet
  \begin{center}
...
\begin{wrapfigure}[5]{l}{8cm}   % [x] Wie manche Zeile soll sich um die Grafik "brechen"
  \vspace{-30pt}      % Grundwert war 20; mit 30 schön oben beim Text ausgerichtet
  \begin{center}
...
Klicken Sie auf das \includegraphics[height=12pt]{/Icons/Fragezeichen.jpg} \col{(2)} erfahren Sie, welche Personen und Gruppen bei der Auswahl 'Standard-Zugriffsrechte' berechtigt werden. Mit Klick auf das Listensymbol \includegraphics[height=12pt]{/Icons/Listensymbol_zurueck.jpg} \col{(3)} kehren Sie zur Dokumentenübersicht zurück.
...
Wird ein Dokument als Link an eine interne oder externe Person / E-Mailadresse versandt, wird im Hintergrund eine weitere Benutzerberechtigung angelegt. Dies wird bei den Berechtigungen mit der Klammer \includegraphics[height=12pt]{/Icons/Pfeil_rechts.jpg} \col{(1)} angezeigt:

\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/11_Dokumentenablage/pictures/dok_erweiterteBerechtigungen1.jpg}}
\caption{erweiterte Zugriffsrechte}
% \label{fig:speciation}
\end{figure}

Mit Klick auf die Klammer \includegraphics[height=12pt]{/Icons/Pfeil_rechts.jpg} \col{(1)} werden diese erweiterten Berechtigungen geöffnet:

\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/11_Dokumentenablage/pictures/dok_erweiterteBerechtigungen2.jpg}}
\caption{erweiterte Zugriffsrechte anzeigen}
% \label{fig:speciation}
\end{figure}

Beim neu angelegten Benutzer lassen sich die Rechte nicht anpassen \col{(2)} (alles ist 'ausgegraut'). Er besitzt lediglich Lese-Rechte.
...
Klicken Sie in der Dokumenten-Übersicht den blauen Titel des gewünschten Dokuments \col{(1)} an. Es öffnen sich die Optionen. Hier oder alternativ wenn Sie sich im Betrachtungsmodus eines Dokuments befinden (erreichbar mit dem Lupensymbol in der Übersicht \includegraphics[height=12pt]{/Icons/Lupe.jpg} \col{(3)}), können Sie unten im Eintrag 'Datei auschecken' \col{(2)} auf das Symbol 'auschecken' \includegraphics[height=12pt]{/Icons/Auschecken.jpg} klicken \col{(4)}. Das Dokument wird ausgecheckt, geöffnet und für die Bearbeitung durch weitere Benutzer gesperrt. Nun können Sie direkt im Dokument arbeiten. 
...
% \caption{Status ändern}
\end{wrapfigure}
Sie können für eine Suchanfrage mehrere Tags auswählen. Dazu klicken Sie rechts von erster Tag-Eingabe \col{(4)} (Diese ist in grauem Feld hinterlegt) ins Suchfeld \col{(5)}. So bald Sie ein Tag ausgewählt haben, beginnt die Suche. Werden weitere Tags ausgewählt, wird die Suche nach jeder Eingabe aktualisiert. 
...
Klicken Sie unter dem Eingabefeld in der Spalte 'Tags' auf das Symbol \includegraphics[height=12pt]{/Icons/Pfeil_rechts.jpg} \col{(1)}. Es wird ein erweitertes Suchfenster ausgeklappt. Im Feld 'verknüpfen' \col{(2)} wählen sie mittels Dropdown-Menü den Wert 'UND' \col{(3)} aus. Die Suche wird jeweils automatisch aktualisiert und sie sehen immer nur die Dokumente, auf welche die Suchkriterien zutreffen. Standardmässig ist der Wert 'ODER' eingestellt, d.h. es muss nur ein Tag der Suchanfrage mit einem Dokument übereinstimmen. \newline
...
\begin{wrapfigure}[10]{l}{8.5cm}   % [x] Wie manche Zeile soll sich um die Grafik "brechen"
...
Die ausgewählten Tags wurden nun in den Filter übernommen \col{(1)} (siehe links). Sie haben nachträglich die Möglichkeit, einzelne Tags (mit \includegraphics[height=12pt]{/Icons/t_loeschen.jpg}) oder auch alle Tags (mit dem Kreuzchen \includegraphics[height=12pt]{/Icons/Kreuzchen_b.jpg} neben dem Titel 'Tags') zu löschen. Sie können nun weitere Tags hinzufügen \col{(2)}, sei es durch Eingabe in die Tag-Zeile oder durch erneutes Navigieren mittels der Ordnerstruktur. 
...
\begin{wrapfigure}[7]{r}{4cm}   % [x] Wie manche Zeile soll sich um die Grafik "brechen"
  \vspace{-35pt}      % Grundwert war 20; mit 30 schön oben beim Text ausgerichtet
  \begin{center}
    \includegraphics[width=.9\linewidth]{../chapters/11_Dokumentenablage/pictures/dok_Tags_erwEinstellungen.jpg}
  \end{center}
  \vspace{-20pt}
%  \caption{Tags filtern}
  \vspace{-10pt}
\end{wrapfigure}

\textbf{Hinweis:} Verwenden Sie mehrere Tag-Kacheln, können Sie aus allen Kacheln beliebige Tags anwählen; diese werden dem Filterfeld \col{(2)} hinzugefügt. In den erweiterten Filtereinstellungen \col{(4)} wird die UND-Verknüpfung \col{(5)} hinterlegt und es werden die erforderlichen Tags 'ausgeschlossen'.
