...
Es wird eine Liste mit den Änderungen ausgeklappt. Ersichtlich sind einerseits vorgenommene Änderungen an den zugehörigen Informationen eines Dokuments (z.B. Autor, Tags) und andererseits Änderungen am Dokument selber (neue Versionen). Eine alte Dokumentenversion können Sie mit der Vorschaufunktion betrachten \includegraphics[height=12pt]{/Icons/Pfeil_rechts.jpg} \col{(5)}. Klicken Sie auf das Downloadsymbol \includegraphics[height=12pt]{/Icons/Download.jpg} \col{(6)}, um eine alte Version des Dokument herunterzuladen oder auf das Lupensymbol \includegraphics[height=12pt]{/Icons/Lupe.jpg} \col{(7)}, um einen alten Stand des Dokuments anzusehen. Sie können die alte Version auch bearbeiten \includegraphics[height=12pt]{/Icons/bearbeiten.jpg} \col{(8)}. \newline
