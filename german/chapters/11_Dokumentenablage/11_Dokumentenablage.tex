...
\text{Beispiel:} In der Tagstruktur (Dokumentenablage) ist der Tag Typ 'Dokumentenart' mit seinen Tags ersichtlich. Bei einem Planungsdossier wird lediglich der Dokumenttyp angehängt:
