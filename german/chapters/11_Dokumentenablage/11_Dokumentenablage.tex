...
Geben Sie den gewünschten Suchbegriff \col{(2)} ein und klicken Sie auf das \includegraphics[height=12pt]{/Icons/Lupe_kl.jpg}-Symbol \col{(3)}. Die Anzeige wird gefiltert und sie erhalten die gefunden Dokumente \col{(4)}. Wollen Sie weitere Filtereinstellungen vornehmen, klicken Sie auf das \includegraphics[height=12pt]{/Icons/Lupe_kl.jpg}-Symbol \col{(1)}. Es erscheinen weitere Suchfelder:
...
Geben Sie die gewünschten oder bekannten Suchkriterien ein und klicken Sie anschliessend auf das \includegraphics[height=12pt]{/Icons/Lupe_kl.jpg}-Symbol. Die gefunden Dokumente werden nun angezeigt. Wollen Sie die erweitereten Filterfelder wieder ausblenden, klicken Sie erneut auf das \includegraphics[height=12pt]{/Icons/Lupe_kl.jpg}-Symbol \col{(1)}.
...
Klicken Sie auf das \includegraphics[height=12pt]{/Icons/Pluszeichen.jpg}-Symbol, um ein neues Foto hochzuladen. Nun können Sie wählen, ob Sie gerade ein Foto aufnehmen oder ein Foto aus der Bibliothek auswählen wollen:

\hspace{15mm} \includegraphics[height=85mm]{../chapters/11_Dokumentenablage/pictures/11-mob09_Foto_aufnehmen.jpg}

\textbf{Anmerkung:} Unter 'Mehr' haben Sie die Möglichkeit auf einen Online-Dienst wie iCloud, Dropbox etc. zuzugreifen, um Dateien aus dieser Ablage hinzuzufügen.

\vspace{\baselineskip}

Nachdem Sie ein Foto aufgenommen oder ausgewhält haben, wird dieses hochgeladen. Füllen Sie nun die gewünschten Felder aus und weisen Sie das Dokument / Foto einem Dossier, einem Projekt etc. zu. Schliessend Sie den Vorgang mit 'Erstellen' ab.
