...
Sie können mittels dem Linksymbol \includegraphics[height=12pt]{/Icons/Link.jpg} \col{(1)} den hinterlegten Link öffnen, wie auch den Link auf Ihrer persönliche Übersicht platzieren. Selbstverständlich können Sie den Link-Eintrag anschauen und bearbeiten. Hingegen fehlen beispielsweise die Optionen 'herunterladen' und 'auschecken'.
