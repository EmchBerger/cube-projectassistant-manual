...
Mit dem Konfigurationssymbol \includegraphics[height=12pt]{/Icons/SpaltenEinst.jpg} \col{(1)} lassen sich Spalten beliebig ein- und ausblenden (Da es hier nur eine Spalte gibt, können Sie bei den Dossiers nichts ändern). Mit Klick auf den Text 'Titel' \col{(2)} werden die aufgeführten Dossiers von A-Z, erneut geklickt, von Z-A sortiert.

\vspace{\baselineskip}

\textbf{Suche:} In der Übersicht können Sie nach Dossiers suchen. Ohne einen Platzhalter (*) zu verwenden, können Sie direkt ein Suchwort eingeben und anschliessend auf die Lupe \includegraphics[height=12pt]{/Icons/Lupe_kl.jpg} \col{(3)} klicken oder die 'Enter'-Taste drücken. Sämtliche Dossiers, welche das Suchwort beinhalten, werden aufgeführt. \newline
...
Um neue Dokumente hochzuladen, wählen Sie das Plussymbol \includegraphics[height=12pt]{/Icons/Plussymbol.jpg} \col{(1)}. Mehr dazu im Kapitel \ref{bkm:Ref442770648}. Mit 'Karte anzeigen / verstecken' \col{(2)} können Sie Google-Maps ein- und ausblenden. Auf der Karte werden alle mit Google Maps verknüpften Dokumente der entsprechenden Suchabfrage angezeigt. Die Volltextsuche \col{(3)} ermöglicht nach beliebigen Begriffen die Einträge zu durchsuchen. Klicken Sie nach Eingabe des Suchwortes auf die Lupe \includegraphics[height=12pt]{/Icons/Lupe_kl.jpg} \col{(8)} oder drücken Sie die 'Enter'-Taste. Es können mehrere Suchbegriffe eingegeben werden. Soll eine bestimmte Wortgruppe gesucht werden, sind die Wörter zwischen Anführungszeichen zu setzen. Bei der Volltextsuche werden die Titel von Dokumenten und Dossiers, die Tags sowie wenn technisch möglich der Dokumentinhalt durchsucht.  Unterhalb dieser Einstellung sehen Sie jeweils wie viele Datensätze gefunden wurden \col{(4)}.\\
Mit dem Konfigurationssymbol \includegraphics[height=12pt]{/Icons/SpaltenEinst.jpg} \col{(5)} können Sie Spalten, welche Sie für die Anzeige nicht benötigen, ausblenden. Nach der Auswahl im erscheinenden Menü klicken Sie dazu auf 'Übernehmen' und schon wird die Ansicht angepasst. \newline
Mit dem Filtersymbol \includegraphics[height=12pt]{/Icons/Filter.jpg} \col{(6)} können Sie die erweiterten Filterfunktionen ein- und ausblenden (Die Funktionen im gelben Rahmen). Für die Verwendung des erweiterten Filters siehe weiter unten 'Erweiterter Filter' (\ref{bkm:Ref201704051}).  \newline
Nebst der Volltextsuche können Sie in den blauen Überschriften \col{(7)} suchen, resp. per Dropdown-Menü auswählen, welche Dokumente angezeigt werden sollen. Mit Klick auf eine blaue Überschrift / einen blauen Spaltentitel wird die angeklickte Spalte von A-Z, mit erneutem Klick, von Z-A sortiert und entsprechend angezeigt. \newline
Sie haben die Möglichkeit die hochgeladenen Dokumente mittels Tags \col{(9)} zu kennzeichnen. Dazu mehr im Kapitel \ref{bkm:Ref442275849}. \\

Wenn Sie auf einen aufgelisteten Datensatz klicken \col{(10)} (Unter Titelspalte, blauer Text), öffnen sich die weiteren Optionen. Erneutes Klicken blendet die Optionen wieder aus. Die Optionen werden weiter unten ausgeführt.
...
Mit dem Filtersymbol \includegraphics[height=12pt]{/Icons/Filter.jpg} \col{(6)} können die erweiterten Filterfunktionen ein- und ausgeblendet werden:
...
Wechseln Sie mittels dem Bearbeiten-Symbol \includegraphics[height=12pt]{/Icons/Bearbeiten.jpg} in den Bearbeitungsmodus des gewünschten Dokumentes (Im Betrachtungsmodus können Sie die Google-Maps-Verknüpfungen anschauen, jedoch keine Verknüpfungen erstellen, hinzufügen oder löschen).
...
Ist das Dokument einem Dossier zugeordnet, gelangen Sie im Feld 'Dossier' mittels dem blauen Textlink \col{(3)} zum entsprechenden Dossier. Unter 'Vorschau' \col{(4)} werden die ersten Seiten des Dokuments in einer verkleinerten Darstellung angezeigt.

\vspace{\baselineskip}

Durch Klicken auf eine Seite der Vorschau \col{(5)}, wird das Dokument im Vorschaumodus auf der entsprechenden Seite geöffnet. Der Vorschaumodus wird durch Klicken auf das graue Kreuzchen \includegraphics[height=12pt]{/Icons/X_Button.jpg} \col{(6)} in der rechten oberen Ecke wieder geschlossen. Mit \includegraphics[height=11pt]{/Icons/Weiter.jpg} , respektive \includegraphics[height=11pt]{/Icons/Zurueck.jpg} \col{(7)} können Sie durch die Seiten des Dokuments blättern. Unterhalb der Seitennavigation ist ersichtlich wie viele Seiten das Dokument umfasst \col{(8)}. Mit dem 90°-Symbol \includegraphics[height=12pt]{/Icons/90Grad.jpg} \col{(9)} können Sie die Seiten jeweils um 90° drehen.
...
Soll das Dokument heruntergeladen werden, klicken Sie im Feld 'Datei' auf das Download-Symbol \includegraphics[height=12pt]{/Icons/Download.jpg} resp. den Dateinamen \col{(1)}. Es wird das gewohnte Downloadfenster des Browsers geöffnet, bei welchem Sie auswählen können, ob die Datei geöffnet oder gespeichert werden soll. Unter 'Statischer Link zu aktuellster Datei-Version' \col{(2)} wird auf die aktuellste Version des Dokuments referenziert. Sie können diesen Link z.B. per Mail versenden und dadurch gewährleisten, dass der Empfänger in jedem Fall auf die aktuellste Version des Dokuments verwiesen wird. Im Feld 'Datei auschecken' \includegraphics[height=12pt]{/Icons/Auschecken.jpg} \col{(3)} wird die aktuellste Version des Dokuments ausgecheckt (siehe Kapitel \ref{bkm:Ref442780171}).
...
Unter dem Punkt 'Änderungshistorie' können Sie sich durch Klicken auf das Symbol \includegraphics[height=12pt]{/Icons/Pfeil_rechts.jpg} \col{(4)} die Änderungen des Dokuments anzeigen lassen.
...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/11_Dokumentenablage/pictures/11-dkorb_Dokumentenkorb_Uebersicht}}
\caption{Der Dokumentenkorb verwenden}
% \label{fig:speciation}
\end{figure}

Suchen Sie mittels Volltextsuche, dem Filter oder der Navigation durch die Dokumente das gewünschte Dokument, welches in den Dokumentenkorb gelegt werden soll. Klicken Sie auf den Dokumententitel \col{(1)} . Es werden die Optionen geöffnet \col{(2)}. Klicken Sie auf das Einkaufswagensymbol \includegraphics[height=12pt]{/Icons/shoppingcart.jpg} \col{(3)}. Nun wird das gewünschte Dokument in den Dokumentenkorb gelegt. Rechts oben im Browserfenster sehen Sie den Dokumentenkorb. Mit Klick auf den Text 'Dokumentenkorb' \col{(10)} können Sie den Dokumentenkorb minimieren oder auch wieder anzeigen lassen.
So bald Sie ein Dokument in den Dokumentkorb gelegt haben, wird das ausgewählte Dokument aufgelistet \col{(4)}. Sie sehen neben der Bezeichnung 'Dokumentenkorb' in Klammern auch die Total-Anzahl der Dokumente, welche sich im Dokumentenkorb befinden. Mittels dem Kreuzchensymbol \includegraphics[height=12pt]{/Icons/blKreuzchen.jpg} \col{(5)} können Sie ein Dokument aus dem Dokumentenkorb wieder entfernen.

\vspace{\baselineskip}

\textbf{Optionen in der Übersicht:}

\begin{compactitem}
	\item Dokument(e) versenden \col{(6)} %\includegraphics[height=12pt]{/Icons/Versandsymbol.jpg}} 
	\item Dokument(e) als Zip herunterladen \col{(7)} %\includegraphics[height=12pt]{/Icons/ZIPSymbol.jpg}}
	\item Planlieferung bestellen \col{(8)} %\includegraphics[height=12pt]{/Icons/printer.jpg}} 
	\item Dokumentenkorb leeren \col{(9)} %\includegraphics[height=12pt]{/Icons/Muelltonne.jpg}} 
\end{compactitem}

\vspace{\baselineskip}

Wollen Sie Ihren Dokumentenkorb komplett leeren, klicken Sie auf das Mülleimersymbol \includegraphics[height=12pt]{/Icons/Muelltonne.jpg} \col{(9)}. Der Dokumentenkorb oben rechts im Browserfenster wird geleert, ausgeblendet und erst wieder sichtbar, wenn Sie neue Dokumente in den Korb legen.
...
\textbf{Dokument direkt als eine Email senden (Ohne Dokumentenkorb):} \newline

In gleicher weise wie oben beschrieben ist es zudem möglich, ein einzelnes Dokument gerade direkt (ohne das Dokument in den Dokumentenkorb zu legen) an einen oder mehrere Email-Empfänger zu versenden.
Gehen Sie dazu wie folgt vor:

\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/11_Dokumentenablage/pictures/11-dkorb_Dok_direkt_senden.jpg}}
\caption{Ein Dokument per Email versenden}
% \label{fig:speciation}
\end{figure}

Suchen Sie mittels der Volltextsuche, dem Filter oder Durchblättern das gewünschte Dokument. Öffnen Sie mit Klick auf den blauen Dokumententitel \col{(1)} die Optionen und klicken Sie auf das Versandsymbol \includegraphics[height=12pt]{/Icons/Versandsymbol.jpg} \col{(2)}. Es öffnet sich ein zusätzliches Fenster, in welchem der / die Empfänger und ein gewünschter Text eingetragen werden kann. Die Details dazu können Sie obiger Ausführung, anfangs des Kapitels \ref{bkm:Ref201701127} entnehmen.

\subsubsection{Dokumente als Zip-Archiv herunterladen}
% Neues Kapitel

Sie haben die Möglichkeit, sämtliche im Dokumentenkorb liegenden Dateien in einem Zip-Archiv herunterzuladen. Klicken Sie dazu auf das Zip-Symbol \includegraphics[height=12pt]{/Icons/ZIPSymbol.jpg}, um sämtliche im Dokumentenkorb abgelegten Dokumente als Zip-Archiv herunterzuladen.
...
Für das Versenden von Plänen via Reprozentren gehen Sie wie folgt vor: Wählen Sie wie oben beschrieben sämtliche benötigten Dokumente / Pläne aus und legen Sie diese in den Dokumentenkorb. In Ihrem Dokumentenkorb sehen Sie nun alle ausgewählten Dokumente. Sie können bei Bedarf mittels dem Kreuzchensymbol \includegraphics[height=12pt]{/Icons/blKreuzchen.jpg} nicht benötigte Dokumente wieder löschen. Sind alle Dokumente / Pläne beisammen, klicken Sie im Dokumentenkorb auf das Drucker-Symbol \includegraphics[height=12pt]{/Icons/printer.jpg}. Es öffnet sich folgendes Fenster:
...
Hier können Sie einen oder mehrere Empfänger auswählen. Gehen Sie wie folgt vor: aus der Dropdownliste 'Empfänger hinzufügen' wählen Sie die gewünschte Person aus. Nach der Auswahl klicken Sie anschliessend auf das Plussymbol \includegraphics[height=12pt]{/Icons/Plussymbol.jpg} \col{(1)}. Wiederholen Sie diesen Schritt mit weiteren benötigten Empfänger. So bald Sie auf das Plussymbol klicken wird die gewünschte Person unten im Dialogfenster aufgeführt. Sie können nun noch einige Einstellungen vornehmen, wie zum Beispiel wie viele Exemplare pro Empfänger benötigt werden und ob der / die Empfänger die Pläne ausgedruckt (Druckexemplar) oder als PDF/Dokument per Mail zugestellt benötigt / benötigen (elektronisch).
...
\textbf{Hinweis}: Im Suchfeld 'Tags' kann nur nach den vorgegebenen Tags gesucht werden. Durch Klicken auf das Fragezeichen-Symbol \includegraphics[height=12pt]{/Icons/Fragezeichen.jpg} neben dem Spaltentitel 'Tags' wird ein Fenster geöffnet. Darin wird aufgelistet aus welchen Tag-Kategorien die entsprechenden Tags ausgewählt werden können. Wollen Sie nach Begriffen suchen, die nicht als 'Tag' definiert sind, benutzen Sie die Volltextsuche.
