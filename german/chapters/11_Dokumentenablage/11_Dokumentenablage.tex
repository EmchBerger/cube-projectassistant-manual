...
Mit Klick auf \includegraphics[height=14pt]{/Icons/B_Uebernehmen.jpg} werden die Daten gespeichert und das Dokument erstellt.
...
Unter 'Nachricht' \col{(2)} können Sie für den oder die Empfänger die nötigen Informationen eingeben. Werden die Dokumente durch Outlook versendet, können Sie die Nachricht noch bearbeiten. Die ausgewählten Dokumente werden aufgelistet und mit Klick auf den blauen Titel lassen sich die Dokumente herunterladen \col{(3)}. Im Dropdownmenü \col{(4)} hinter den Dokumenten können Sie auswählen, ob ein Dokument\\
