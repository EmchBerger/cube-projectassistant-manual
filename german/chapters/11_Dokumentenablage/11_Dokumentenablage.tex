...
%  \caption{Tagstruktur}
  \vspace{-10pt}
\end{wrapfigure}
Im Bearbeitungsmodus eines Dokuments wird das gewünschte strukturierte Dossier verknüpft \col{(3)}. Klicken Sie auf den Button Tagstruktur \col{(4)}, um das Dokument innerhalb der Gliederung in der gewünschten Position einzureihen:
...
\textbf{Hinweis:} Wenn Sie in den Filterfeldern bei 'Dossier' und/oder 'Tags' Auswahlen getroffen haben und mittels dem Plussymbol \includegraphics[height=12pt]{/Icons/Plussymbol.jpg} \col{(1)} ein neues Dokument hochladen, werden diese Auswahlen in der Maske für den neuen Dokumenteneintrag bereits hinterlegt.
