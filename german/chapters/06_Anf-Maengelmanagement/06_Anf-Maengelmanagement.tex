...
Selbst einer Statusänderung kann ein Dokument angehängt \col{(1)} oder ein Dokument verlinkt \col{(2)} werden. Beispielsweise kann ein Foto eines Nachweises hinzugefügt werden. 
