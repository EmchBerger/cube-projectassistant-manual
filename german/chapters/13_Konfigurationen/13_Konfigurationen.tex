...
\begin{compactitem}
	...
	\item \textbf{Hinweis:} Insgesamt sind 10 Ebenen möglich.
\end{compactitem}	
...
Sobald eine Änderung vorgenommen wurde, erhalten Sie folgende Meldung:
\vspace{-5pt}
\begin{figure}[H]
\center{\includegraphics[width=.4\linewidth]{../chapters/13_Konfigurationen/pictures/konf_Status_ungAenderungen.jpg}}
\end{figure}
\end{mdframed}
