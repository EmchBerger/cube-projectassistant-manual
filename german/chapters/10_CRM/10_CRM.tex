...
Zudem können Teilnehmerlisten erfasst werden. Wählen Sie dazu links im Menü den Punkt 'Customer Relationship Management' und den Unterpunkt 'Teilnehmerlisten'. Mit Klick auf das Plussymbol (\includegraphics[height=12pt]{/Icons/Plussymbol.jpg}) erstellen Sie eine neue Teilnehmerliste:

\begin{figure}[H]
\center{\includegraphics[width=.8\linewidth]{../chapters/10_CRM/pictures/crm_Teilnehmerlisten.jpg}}
% \caption{Neue Teilnehmerlisten erstellen}
% \label{fig:speciation}
\end{figure}

Geben Sie der Teilnehmerliste einen Namen (Pflichtfeld) und wählen Sie die gewünschten Teilnehmer aus (Pflichtfeld). Fehlen bei der Auswahl gewünschte Personen müssen diese zuerst in der Adressliste erfasst werden (siehe Kapitel \ref{bkm:Ref2018071901}).

\vspace{\baselineskip}

Mit 'Erstellen' werden die Daten gespeichert.
