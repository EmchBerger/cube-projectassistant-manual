...
Das Hochladen von Beilagen ist vor allem dazu gedacht, das Erfassen von langen Erklärungen zu vermeiden und dafür auf eine hochgeladene Beilage zu verweisen.
...
\begin{itemize}
\item
Titel \col{(2)}: Geben Sie einen passenden Titel ein (Pflichtfeld).
\item
Laden Sie die Beilage hoch, indem Sie auf die Schaltfläche 'Durchsuchen' \col{(3)} klicken und eine Datei per Doppelklick auswählen. Falls Sie eine falsche Datei gewählt haben, laden Sie einfach eine neue hoch.
\item
