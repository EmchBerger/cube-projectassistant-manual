...
\begin{compactitem}
	...
	\item eine Sitzung kopieren \col{(13)}. Mehr dazu unten im Kapitel \ref{bkm:Ref2017112701}.
	\end{compactitem}
	
Die Status-Spalte \col{(14)} zeigt an, ob ein Protokoll archiviert wurde und somit 'Definitiv' ist. Trägt eine Sitzung diesen Status sind obige Optionen nicht mehr möglich. Mittels dem Blattsymbol \includegraphics[height=12pt]{/Icons/Blattsymbol.jpg} kann das definitive Protokoll als PDF geöffnet oder gespeichert werden.
