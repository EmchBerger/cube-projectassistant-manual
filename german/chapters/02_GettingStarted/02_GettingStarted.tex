...
\textbf{Löschen:} Die Verwendung der 'Backspace'-Taste ist für Lösch-Tätigkeiten nicht zu empfehlen, da Sie innerhalb des Browsers auch für 'Seiten zurück' verwendet wird.
...
\textbf{Status- / Workflow-Übersicht:} In den verschiedenen Übersichten (Dokumente, Dossiers, Vorbehalte, Rechnungen u.a.) neben der 'Status'-Spalte und innerhalb Einträgen (Ansichts- oder Bearbeitungsmodus) beim Feld 'Status' finden Sie jeweils ein \includegraphics[height=12pt]{/Icons/Fragezeichen.jpg}-Symbol. Mit Klick auf das Icon erhalten Sie vom aktuellen Statussystem / Workflow eine Übersicht. Ein zusätzliches Fenster wird geöffnet:
