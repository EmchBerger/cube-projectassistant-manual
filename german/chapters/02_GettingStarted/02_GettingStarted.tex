...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/02_GettingStarted/pictures/2-5-4_WarnungPflichfelder}}
...
\pagebreak
\subsection{Die Übersicht in den verschiedenen Modulen bedienen}
...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{../chapters/02_GettingStarted/pictures/uebersicht_Bedienung}}
