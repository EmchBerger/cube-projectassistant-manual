...
\pagebreak
\subsubsection{Adressliste} % Sub-sub-section
...
\subsubsection{Terminplanung} % Sub-sub-section
...
\subsubsection{Sitzungswesen} % Sub-sub-section
...
\subsubsection{Geschäfte} % Sub-sub-section
...
\subsubsection{Beschaffungswesen} % Sub-sub-section
...
\subsubsection{Anforderungen} % Sub-sub-section
...
\subsubsection{Qualitätsmanagement / Handbücher} % Sub-sub-section
...
\subsubsection{Dokumentenablage} % Sub-sub-section
...
\subsubsection{Importieren} % Sub-sub-section

Mittels dieser Option können Terminpläne und Geschäfte (Daten) importiert werden.

\subsubsection{Konfiguration} % Sub-sub-section
...
\subsubsection{Benutzerverwaltung} % Sub-sub-section
