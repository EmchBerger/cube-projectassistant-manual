...
\textbf{Wichtig:} Wenn Sie nicht wissen, in welchem Feld Sie sich aktuell befinden, können Sie mit dem Mauszeiger in den Feldbereich fahren und dort kurz stehen bleiben. Nun wird der Feldname eingeblendet \col{(6)}. Zudem sehen Sie auch gleich, ob es sich beim Feld um ein Pflichtfeld handelt: Diese sind mit einem * gekennzeichnet. 
