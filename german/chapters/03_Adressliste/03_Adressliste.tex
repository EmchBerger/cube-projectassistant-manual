...
Wurden die benötigten Änderungen vorgenommen, können Sie mit Klick auf \includegraphics[height=12pt]{/Icons/ueb_schliessen.png} \col{(2)} die Änderungen speichern und die Maske schliessen. Die Übersicht wird wieder angezeigt. Falls Sie nur eine Zwischenspeicherung der Änderunge machen wollen, klicken Sie auf \includegraphics[height=12pt]{/Icons/B_Uebernehmen.jpg}.
...
Sie können nun die Änderungen vornehmen und mittels dem \includegraphics[height=14pt]{/Icons/Speichern.png}-Button oder mit erneutem Doppelklick im umrahmten Bereich abspeichern.
