...
\begin{itemize}
  \item[$\Longrightarrow$] Links sehen Sie sämtliche Module, welche für Sie freigeschatlet sind.
...
\begin{itemize}
  \item[$\Longrightarrow$] Mit Klick auf \includegraphics[height=12pt]{Icons/Menu_Aus-Ein.jpg} links des Emch+Berger Logos können Sie das Menü ein- und ausschalten. So gewinnen Sie eine grössere Arbeitsfläche.
	\item[$\Longrightarrow$] Arbeiten Sie mit mehreren Instanzen, können Sie mit Klick auf \includegraphics[height=12pt]{Icons/Menu_Aus-Ein.jpg} rechts der Eingabezeile 'Was möchten Sie tun?' die Instanzen wechseln.
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
 ...
 \item[$\Longrightarrow$] Rechts finden Sie die Pendenzen, für welche Sie verantwortlich sind. Mit Klick auf \includegraphics[height=10pt]{Icons/Pfeil_rechts.jpg} öffnen Sie die entsprechenden Pendenzen. Mit \includegraphics[height=10pt]{Icons/bearbeiten.jpg} können Sie eine Pendenz gleich bearbeiten.
 \item[$\Longrightarrow$] Bei der Dokumentenübersicht finden Sie die von Ihnen ausgecheckten Dokumenten in der Übersicht. Zudem werden alle Dokumente angezeigt, welche sie favorisiert haben. Oft verwendete und gespeicherte Filter werden ebenfalls angezeigt und mit einem Klick wechseln Sie in die Dokumentenablage und in die entsprechende Filterung.
 \item[$\Longrightarrow$] Bei der Übersicht über Beschaffungen werden die Beschaffungen angezeigt, bei welchen Sie Aufgaben wahrnehmen müssen. So zum Beispiel bei der Vertragsüberwachung: Alle Verträge die von Ihnen begleitet werden, sehen Sie aufgelistet.
\end{itemize}
\end{beamerlikethm}
...
\begin{itemize}
  ...
  \item[$\Longrightarrow$] Optional können Sie Dokumente aus der Dokumentenablage verlinken. Klick auf das \includegraphics[height=10pt]{Icons/Link.jpg}-Symbol, wählen Sie die gewünschte Datei aus, ergänzen Sie die nötigen Felder und speichern Sie die Eingaben mit \includegraphics[height=10pt]{Icons/B_Uebernehmen.jpg}.
...
\begin{beamerlikethm}{Hinweise}
\begin{itemize}
  \item[$\Longrightarrow$] In verschiedenen Modulen von CUBE PA können nebst den vorgegebenen Feldern zusätzlich auch benutzerdefinierte verwendet werden.
...
\begin{itemize}
  ...
  \item[$\Longrightarrow$] Klick auf \includegraphics[height=10pt]{Icons/vCard.jpg} öffnet eine vCard (Visitenkarte für Outlook) 
	\item[$\Longrightarrow$] Klick auf die Emailadresse öffnet neue Nachricht in Ihrem Emailprogramm
	\item[$\Longrightarrow$] Klick auf das Telefon ermöglicht direkten Anruf (Abhängig vom verwendeten Telefonsystem).
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item[$\Longrightarrow$] \textbf{Hinweis:} Firmen werden durch Administratoren unter 'Konfiguration' und 'Beteiligte' noch detailierter eingestellt. Dort wird definiert, ob sie beispielsweise 'Anbieter' für eine Beschaffung ist, ob die Firma ein Gremium darstellt oder als Reprozentrum funktioniert.
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item[$\Longrightarrow$] Mit Klick auf \includegraphics[height=10pt]{Icons/Plussymbol.jpg} eröffnen Sie ein neues Konto. Füllen Sie die Felder aus, weisen Sie das Konto einer Beschaffung zu.
...
\begin{itemize}
  \item[$\Longrightarrow$] Klicken Sie im Menü links auf 'Controlling' und dann auf ihre Übersicht.
	\item[$\Longrightarrow$] Sie sehen Ihren Kontenplan. CUBE PA nimmt aus den verknüpften Beschaffungen die Vertragssummen hinzu. Auch Nachtragsbeschaffungen werden bei der Rechnung berücksichtigt.
...
\begin{itemize}
  ...
  \item[$\Longrightarrow$] \textbf{Sortieren:} Mit Klick auf die blaue Spaltenbezeichnung lassen sich die Datensätze von A nach Z oder mit erneutem Klick Z nach A sortieren.
